...
public class DailyScheduled {
    ...
    @Autowired private CharacterRepo characterRepo;
    @Autowired private ChatRepo chatRepo;
    @Autowired private ChatMessageRepo chatMessageRepo;
    @Autowired private LocationMessageRepo locationMessageRepo;
    @Autowired private LocationPosterRepo locationPosterRepo;
    @Autowired private BoardDiscussionRepo boardDiscussionRepo;
